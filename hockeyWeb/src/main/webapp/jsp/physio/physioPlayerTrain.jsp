...
<html>
<head>
    <title> <fmt:message key="pagetitle.physioplayertrain" bundle="${rb}"/> </title>
    <link rel="stylesheet" type="text/css" href="../../css/style.css">
</head>
<body>

<c:set var="previousCommand" scope="session" value="physio_player_train"/>
...
<form action="Controller" method="post">
    <input type="hidden" name="command" value="physio_do_player_train">
